  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="min-w-[300px] w-[30vw] mt-6 text-4xl md:text-5xl bg-blue-400 duration-500 py-4 border-[3px] border-blue-400 hover:bg-blue-500 hover:rounded-xl hover:border-blue-900"
      >
        Start
      </button>
    </motion.div>
